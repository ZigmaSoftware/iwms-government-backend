"""API tests for WasteCollectionSub (bluetooth) endpoint."""
import pytest

BASE = "/api/v1/waste-bluetooth/collection-sub/"


@pytest.mark.django_db
class TestWasteCollectionSubAPIList:
...
@pytest.mark.django_db
class TestWasteCollectionSubAPIRetrieve:
