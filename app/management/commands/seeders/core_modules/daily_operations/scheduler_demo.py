...
Run it on its own:
    ...
    # or run the scheduler demo group:
    python manage.py seed --group scheduler-demo
...
class SchedulerDemoSeeder(BaseSeeder):
    ...
    def run(self):
        ...
        self.log("  python manage.py generate_daily_trips")
        self.log(f"Or trigger via API: POST /api/v1/schedule-operations/daily-trip-assignments/generate-daily/")
        self.log("=" * 60)
